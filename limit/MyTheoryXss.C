...
void MyTheoryXss(){
  ...
  //lambdaVecAll.push_back(lambVec3500);
  ...
  graphVecLabel.push_back("lambda_250");
  graphVecLabel.push_back("lambda_500");
  graphVecLabel.push_back("lambda_750");
  graphVecLabel.push_back("lambda_1000");
  graphVecLabel.push_back("lambda_1250");
  graphVecLabel.push_back("lambda_1500");
  graphVecLabel.push_back("lambda_1750");
  graphVecLabel.push_back("lambda_2000");
  graphVecLabel.push_back("lambda_2500");
  graphVecLabel.push_back("lambda_3000");
  //graphVecLabel.push_back("lambda_3500");
